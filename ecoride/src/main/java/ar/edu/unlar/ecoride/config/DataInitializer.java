...
public class DataInitializer {
        ...
        public CommandLineRunner initData(AlquilerService alquilerService) {
                return args -> {
                        ...
                        centro.agregarVehiculo(Monopatin.builder()
                                        .patente("MONO1")
                        ...
                        centro.agregarVehiculo(BicicletaElectrica.builder()
                                        .patente("BICI1")
                        ...
                        norte.agregarVehiculo(BicicletaElectrica.builder()
                                        .patente("BICI2")
                        ...
                        System.out.println(
                                        "            Ejemplo: http://localhost:8080/api/alquileres/desbloquear-params?idUsuario=1&patente=MONO1&metodoPago=TARJETA");
                        System.out.println("");
                        ...
                        System.out.println(
                                        "       - Patente [MONO_BAJO] - Monopatín (Batería 10% - Carga insuficiente)");
